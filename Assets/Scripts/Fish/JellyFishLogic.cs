...
public class JellyfishAnimation : MonoBehaviour
{
    ...
    public float animatorDistance = 120f;
    ...
    private void Update()
    {
        // If in range, then continue cycle, if not save performance
    ...
    {
        if (PlayerInRange(attackDistance) && !stingActive)
        {
    ...
    private bool PlayerInRange(float distanceCheck)
    {
